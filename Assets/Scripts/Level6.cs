...
public class Level6 : Level
{
    ...
    void LoadPuzzle()
    {
        ...
        #region line 1
        LV.pos[0][0].GetComponent<BlockType>().floorTile = "grass_3_3";
        ...
        LV.pos[3][1].GetComponent<BlockType>().floorTile = "grass_2_5"; 
        ...
        LV.pos[1][2].GetComponent<BlockType>().floorTile = "grass_1_1"; 
        ...
        LV.pos[3][2].GetComponent<BlockType>().floorTile = "grass_1_7_2";
        ...
        LV.pos[6][2].GetComponent<BlockType>().floorTile = "grass_1_7_3";
        ...
        LV.pos[1][3].GetComponent<BlockType>().floorTile = "grass_2_1";
        ...
        #region line 5
        LV.pos[0][4].GetComponent<BlockType>().floorTile = "grass_1_2";
        LV.pos[0][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);

        LV.pos[1][4].GetComponent<BlockType>().floorTile = "grass_1_7_3";

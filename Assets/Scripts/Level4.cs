...
public class Level4 : Level
{
    ...
    public override void LoadSprites()
    {
        ...
        mage_file = "Sprites/Enemies/GreenMage";
    ...
    void LoadPuzzle()
    {
        ...
        LV.pos[6][1].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.MovableRock); 
        ...
        LV.pos[6][2].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall);
        ...
        LV.pos[1][3].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water); 
        LV.pos[2][3].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        ...
        #region line 5
        LV.pos[0][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[1][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[2][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[3][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);

        LV.pos[4][4].GetComponent<BlockType>().floorTile = "grass_2_1";
        ...
        LV.pos[6][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        LV.pos[7][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        LV.pos[8][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        LV.pos[9][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        #endregion

        #region line 6
        LV.pos[0][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        ...
        LV.pos[3][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);

        LV.pos[4][5].GetComponent<BlockType>().floorTile = "grass_2_1";
        ...
        LV.pos[6][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall);
        LV.pos[7][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        LV.pos[8][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        LV.pos[9][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        #endregion

        #region line 7
        LV.pos[0][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[1][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[2][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[3][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);

        LV.pos[4][6].GetComponent<BlockType>().floorTile = "grass_2_1";
        ...
        LV.pos[8][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall);
        LV.pos[9][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        #endregion

        #region line 8
        LV.pos[0][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[1][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[2][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);
        LV.pos[3][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Water);

        LV.pos[4][7].GetComponent<BlockType>().floorTile = "grass_2_1";
        ...
        LV.pos[8][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        LV.pos[9][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        #endregion

        #region line 9
        LV.pos[0][8].GetComponent<BlockType>().floorTile = "grass_1_2";
        LV.pos[0][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);

        LV.pos[1][8].GetComponent<BlockType>().floorTile = "grass_1_2";
        LV.pos[1][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);

        LV.pos[2][8].GetComponent<BlockType>().floorTile = "grass_1_2";
        LV.pos[2][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.MovableRock);

        LV.pos[3][8].GetComponent<BlockType>().floorTile = "grass_1_2";
        LV.pos[3][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);

        LV.pos[4][8].GetComponent<BlockType>().floorTile = "grass_1_7_3";
        LV.pos[4][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.MovableRock);

        LV.pos[5][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        LV.pos[6][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall);
        LV.pos[7][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Hole);
        LV.pos[8][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        LV.pos[9][8].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Hole);
        #endregion

        #region line 10
        LV.pos[0][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Orb);
        ...
        LV.pos[3][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.MovableRock);
        ...
        LV.pos[7][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Mage);
        LV.pos[8][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall);
        LV.pos[9][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Collectable);
        #endregion

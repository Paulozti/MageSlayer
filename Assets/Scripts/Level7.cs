...
public class Level7 : Level
{
    ...
    void LoadPuzzle()
    {
        ...
        LV.pos[4][0].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall); 
        ...
        LV.pos[3][1].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor); 
        ...
        LV.pos[6][2].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        ...
        LV.pos[3][3].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        ...
        LV.pos[6][3].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        ...
        #region line 5
        LV.pos[0][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        ...
        LV.pos[9][4].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        #endregion

        #region line 6
        LV.pos[0][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        ...
        LV.pos[9][5].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        #endregion

        #region line 7
        LV.pos[0][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        ...
        LV.pos[9][6].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        #endregion

        #region line 8
        LV.pos[0][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        ...
        LV.pos[6][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Floor);
        ...
        LV.pos[9][7].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Tree);
        #endregion
        ...
        LV.pos[4][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Mage);
        LV.pos[5][9].GetComponent<BlockType>().ChangeBlockType(BlockType.Type.Wall);
